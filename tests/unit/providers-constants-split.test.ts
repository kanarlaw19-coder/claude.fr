...
// the Cheaper Inference gateway (OSS-sponsor reseller, gateways family) to 196. Retiring GitHub
// Models removes its inference-host entry and brings the API-key total to 195.
