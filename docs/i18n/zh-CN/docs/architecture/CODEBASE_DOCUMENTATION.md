...
└── mcp-server/             MCP 服务器（3 种传输、32 个权限域、107 个工具）
```
...
| 关注领域        | 文件                                                                                                                                                                                                                                              |
| --------------- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| Combo 路由      | `combo.ts`（19 种公开策略）、`comboConfig.ts`、`comboMetrics.ts`、`comboManifestMetrics.ts`、`comboAgentMiddleware.ts`                                                                                                                            |
...
- **32 个权限域**在 `src/shared/constants/mcpScopes.ts` 中声明。
